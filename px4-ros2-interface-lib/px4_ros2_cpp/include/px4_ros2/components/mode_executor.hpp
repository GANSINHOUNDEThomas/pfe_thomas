...
public:
  ...
  struct Settings
  {
    ...
    Activation activation{Activation::ActivateAlways};
  };
  ...
  */
  ...
  void Manual_mode_PosCtl(const CompletedCallback & on_completed);//ajouté par moi
  ...
  ModeBase::ModeID getCurrentNavState() const {return _prev_nav_state;} // ajouté par moi
...
private:
  ...
  ModeBase::ModeID _curr_nav_state{ModeBase::kModeIDInvalid}; // ajouté par moi
